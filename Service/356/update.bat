@set caller=0
@set version2="1002698"
@set version3="1.0.0.2698"
...
@set tam="3,23"
@set totaltam=3395341
@set installedsize="4,68"
@set hash=C73C4F256D6B575B03FEB6B1B67F2CBAC612A9BBB258EA78CA0BFB3C3FB00B4D
@set file=AOMBR.7z
