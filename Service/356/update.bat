@set caller=0
@set version2="1002693"
@set version3="1.0.0.2693"
...
@set tam="2,74"
@set totaltam=2876022
@set installedsize="4,09"
@set hash=6DB1587C7A3E9C058F281D8C514E9E337EED71C411BB9E37EC7DD7CB89173E0B
@set file=AOMBR.7z
