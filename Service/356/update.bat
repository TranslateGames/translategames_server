@set caller=0
@set version2="1002678"
@set version3="1.0.0.2678"
...
@set tam="2,76"
@set totaltam=2902884
@set installedsize="4,34"
@set hash=85132BD433B4D6A2D9C955DA719B1C37C58E014708EE44EE7352044E3D29EB96
@set file=AOMBR.7z
