@set caller=0
@set version2="1002689"
@set version3="1.0.0.2689"
...
@set tam="2,76"
@set totaltam=2899671
@set installedsize="4,2"
@set hash=CA10707A6A4B81501B3E8D7E11CD089FF169EF5EA116A24BD5B5C5E109C6320E
@set file=AOMBR.7z
